package com.hadluo.store.service.config;
...
@Configuration
@Mapper
@MapperScan(basePackages = "com.hadluo.store.service.mapper")
public class MybatisConfigure {
	...
	private String typeAliasPackage = "com.hadluo.store.api.pojo";
