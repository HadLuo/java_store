...
public class DefaultChatController extends AbstarctChatController {
    ...
    @Override
    public void storePause(String uuid, String groupWxId,int second) {
        pauseStore.pause(getAlias(), uuid, groupWxId,second);
    }
    ...
    @Override
    public String checkPause(ChatGroup chatGroup) {
        List<Chat> chats = chatGroup.getChats();
    ...
    @Override
    public void clearStore(String uuid, String groupId) {
        chatHahStore.delGroup(getAlias(), uuid, groupId);
        groupStatusStore.delGroup(getAlias(), uuid, groupId);
        pauseStore.delGroup(getAlias(), uuid, groupId);
    }
