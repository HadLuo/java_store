...
public class Chat implements Serializable {
    ...
    private int delay;
    /** 需要发送的 所有微信 群 id */
    private List<String> needSendGroupWxIds;
    /** 当前发言人排序 */
    private int sort;
    ...
    public Chat(int delay, int sort, List<String> needSendGroupWxIds) {
    ...
    public Chat(String groupUuid, int delay, int sort, String needSendGroupWxIds) {
        this.createTime = System.currentTimeMillis();
        this.delay = delay;
        this.needSendGroupWxIds = new ArrayList<String>(
    ...
    public List<String> getNeedSendGroupWxIds() {
        return needSendGroupWxIds;
    }

    public void setNeedSendGroupWxIds(List<String> needSendGroupWxIds) {
        this.needSendGroupWxIds = needSendGroupWxIds;
    }
